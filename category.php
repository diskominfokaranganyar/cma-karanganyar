   ...
   <?php include('includes/header.php');?>
    ...
    <div class="container">
      ...
      <?php 
        ...
        $query=mysqli_query($con,"select offline_posts.id as pid,offline_posts.title as posttitle,tblcategory.CategoryName as category,offline_posts.description as description,offline_posts.posting_date as postingdate, offline_post_images.url as PostImage from offline_posts JOIN offline_post_images ON offline_posts.id = offline_post_images.post_id left join tblcategory on tblcategory.id=offline_posts.category_id where offline_posts.category_id='".$_SESSION['catid']."' and offline_posts.active=1 order by offline_posts.id desc LIMIT $offset, $no_of_records_per_page");
